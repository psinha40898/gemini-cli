          ...
          {buffer.text.length === 0 && placeholder ? (
            ...
            linesToRender
              .map((lineText, visualIdxInRenderedSet) => {
                ...
                const [logicalLineIdx, logicalStartCol] =
                  buffer.visualToLogicalMap[absVisualIdx] ?? [0, 0];
                ...
                const highlightMask: boolean[] = new Array(logicalMaskLength).fill(
                  false,
                );
                let runningOffset = 0;
                ...
                for (let i = 0; i < chars.length; i++) {
                  ...
                  const color =
                    logicalCol >= 0 && logicalCol < highlightMask.length &&
